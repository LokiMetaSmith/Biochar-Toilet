...
<div class="slide-container bleed-image-layout">
    <div class="bleed-text-side" style="padding: 30px 40px; justify-content: center;">
        <h2 class="slide-title" style="margin-bottom: 12px; font-size: 1.9rem; line-height: 1.1;">Induction Hardware: Current Development Status</h2>
        <div class="content-area" style="font-size: 0.9rem; line-height: 1.4;">
    ...
    if target_original in html:
        ...
        with open('/tmp/test_deck5.html', 'w') as f:
            f.write(modified_html)

        async with async_playwright() as p:
            browser = await p.chromium.launch()
            page = await browser.new_page(viewport={"width": 1280, "height": 720})
            await page.goto("file:///tmp/test_deck5.html")
            ...
            if slide_element:
                ...
                await container.screenshot(path='/tmp/test_slide13.png')
                print("Screenshot saved to /tmp/test_slide13.png")
            else:
