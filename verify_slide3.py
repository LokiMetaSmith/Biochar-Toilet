...
<div class="slide-container bleed-image-layout">
    <div class="bleed-text-side" style="padding: 20px 40px; justify-content: center;">
        <h2 class="slide-title" style="margin-bottom: 10px; font-size: 2rem; line-height: 1.1;">Induction Hardware: Current Development Status</h2>
        <div class="content-area" style="font-size: 0.95rem; line-height: 1.35;">
    ...
    if target_original in html:
        ...
        with open('/tmp/test_deck3.html', 'w') as f:
            f.write(modified_html)

        async with async_playwright() as p:
            browser = await p.chromium.launch()
            page = await browser.new_page(viewport={"width": 1280, "height": 720})
            await page.goto("file:///tmp/test_deck3.html")
            ...
            if slide_element:
                ...
                await container.screenshot(path='/tmp/test_slide11.png')
                print("Screenshot saved to /tmp/test_slide11.png")
            else:
