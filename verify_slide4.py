...
<div class="slide-container bleed-image-layout">
    <div class="bleed-text-side" style="padding: 40px 50px;">
        <h2 class="slide-title" style="font-size: 38px; margin-bottom: 20px; margin-top: 0;">Induction Hardware: Current Development Status</h2>
        <div class="content-area" style="font-size: 20px; line-height: 1.4;">
    ...
    if target_original in html:
        ...
        with open('/tmp/test_deck4.html', 'w') as f:
            f.write(modified_html)

        async with async_playwright() as p:
            browser = await p.chromium.launch()
            page = await browser.new_page(viewport={"width": 1280, "height": 720})
            await page.goto("file:///tmp/test_deck4.html")
            ...
            if slide_element:
                ...
                await container.screenshot(path='/tmp/test_slide12.png')
                print("Screenshot saved to /tmp/test_slide12.png")
            else:
